<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CSEOffice.aspx.cs" Inherits="CSEOffice" %>
...
<body>
    ...
    <center>
        <form id="form1" runat="server">
            ...
            <br />
            <asp:Label ID="schudule" runat="server" Text="Get Student Data" Width="150px"></asp:Label>
            <asp:TextBox ID="inputDate" runat="server" placeholder="From" Text="2019-12-26" Type="date" required></asp:TextBox>
            <asp:Button ID="ButtonGetStudentData" runat="server" onclick="ButtonGetStudentData_Click" Text="Submit" />
        </form>
    </center>
</body>
</html>
